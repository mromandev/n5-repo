        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NombreEmpleado = table.Column<string>(type: "nvarchar(70)", maxLength: 70, nullable: false),
                    ApellidoEmpleado = table.Column<string>(type: "nvarchar(70)", maxLength: 70, nullable: false),
